package expo.modules.innertube.utils

import expo.modules.innertube.YouTube
import expo.modules.innertube.pages.LibraryPage
import expo.modules.innertube.pages.PlaylistPage
...
suspend fun Result<LibraryPage>.completed(): Result<LibraryPage> = runCatching {
  ...
  LibraryPage(items = items, continuation = page.continuation)
}
